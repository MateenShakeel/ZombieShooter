...
namespace Manoeuvre
{
    ...
    public class ShooterAIStateManagerEditor : Editor
    {
         ...
         void DrawNewInspector()
        {
            ...
            playercontroller Player = _stateManager.Player;
            if(_AIType == AIType.Companion)
            {
                Player = (playercontroller)EditorGUILayout.ObjectField("Player", _stateManager.Player, typeof(playercontroller));
		...
		void DrawAttackBehaviour (){
            ...
            playercontroller Player = (playercontroller)EditorGUILayout.ObjectField ("Player", _stateManager.AttackBehaviour.Player, typeof(playercontroller));
