...
namespace uzAI
{
    ...
    public class uzAIZombieStateManagerEditor : Editor
    {
        ...
        void DrawAttackProperties()
        {
            ...
            playercontroller Player = _stateManager.attackBehaviour.Player;
            ...
            if (attackToggle)
            {
                ...
                Player = (playercontroller)EditorGUILayout.ObjectField("Player", _stateManager.attackBehaviour.Player, typeof(playercontroller));
