...
namespace TacticalAI
{
    public class HitBox : MonoBehaviour
    {
        ...
        public void DamageByPlayer (float damage)
        {
            if (myScript) {
                ...
                StartCoroutine (nameof(StoreDamageTakenRecently), damage);

                if (HeadHitBox)
                {
                    InGameProperties.Instance.HeadShotEvent();
